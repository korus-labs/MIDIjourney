...
, 			{
		...
		"parameters" : 		{
			"obj-24" : [ "model", "model", 0 ],
			"obj-26" : [ "historyStatus[1]", "historyStatus", 0 ],
			"obj-42" : [ "temperature[1]", "temperature", 0 ],
			"obj-48::obj-54" : [ "Validate", "Validate", 0 ],
			"obj-8" : [ "apiKey", "apiKey", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
, 			{
				"name" : "validate.svg",
				"bootpath" : "~/Github/Midijourney/images",
