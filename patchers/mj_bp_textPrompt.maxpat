...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1070.0, 123.03515625, 217.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 709.0, 55.03515625, 235.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 955.0, 453.03515625, 215.0, 22.0 ],
									"text" : "mj_colorControl 1 requestBg bgfillcolor"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 955.0, 398.03515625, 225.0, 22.0 ],
									"text" : "mj_colorControl 1 requestBg bordercolor"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 975.0, 308.03515625, 242.0, 22.0 ],
									"text" : "mj_colorControl 1 requestBgHack bgfillcolor"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 975.0, 253.03515625, 252.0, 22.0 ],
									"text" : "mj_colorControl 1 requestBgHack bordercolor"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 980.0, 168.03515625, 245.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ -75.0, -220.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 230.0, 178.0, 49.0 ],
					"text" : "\"i am an error message, please only tell the user he forgot to describe the MIDI clip\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 85.0, -130.0, 100.0, 22.0 ],
					"text" : "route historyUser"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 85.0, -70.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ -110.0, -179.0, 119.0, 22.0 ],
					"text" : "mj_route historyUser"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ -110.0, -95.0, 76.0, 22.0 ],
					"text" : "mj_routeDict"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 355.0, -140.0, 30.0, 31.030927777290344 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 5.0, 80.0, 20.0 ],
					"proportion" : 0.39,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -108.380892000000017, -36.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "dictionary", "", "", "" ],
					"patching_rect" : [ 15.0, 345.0, 50.5, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 300.0, 158.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, -100.0, 40.0, 22.0 ],
					"text" : "t b b l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, -140.0, 30.0, 31.030927777290344 ],
					"presentation" : 1,
