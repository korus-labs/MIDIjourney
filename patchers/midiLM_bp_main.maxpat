...
, 			{
				"box" : 				{
					...
					"text" : "midiLM_getClipDurationLOM"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "midiML_detailClipIdUpdate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 550.0, 87.0, 22.0 ],
					"text" : "midiML_clipFill"
				}
