...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "mj_consolePrint highlightedSlot: \"STEP - Input Clip Slot\""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 21.0, 206.0, 102.0, 22.0 ],
					"text" : "mj_routeDict"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "int", "" ],
					"patching_rect" : [ 177.0, 40.0, 40.0, 22.0 ],
					"text" : "t b 1 l"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "mj_getFromId highlighted_clip_slot"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 177.0, 129.0, 53.0, 22.0 ],
					"text" : "live.path"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 177.0, 83.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dictionary" ],
					"patching_rect" : [ 21.0, 153.0, 30.0, 30.0 ]
				}
